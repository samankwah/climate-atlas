...
function ClimateAtlas() {
  ...
  const { data: climateData, isLoading: loadingClimate } = useClimateData(
    variable,
    period,
    scenario
  );
  ...
  // Handler for find me geolocation
  const handleFindMe = useCallback(() => {
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          console.log("Location found:", position.coords);
          // TODO: Pan map to user location
        },
        (error) => {
    ...
    <div className="climate-atlas-redesign">
      ...
      <div className="map-container">
        ...
        <div className="map-area">
          ...
          {(loadingDistricts || loadingClimate) && !districtsError && (
        ...
        {/* Floating sidebar with layer toggles */}
        <MapLayerToggles
          showGrid={showGrid}
