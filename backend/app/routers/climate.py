    ...
    for region_name, district_list in REGIONS.items():
        ...
        for district_name in district_list:
            ...
            if is_gdd:
                ...
                value = max(0, (max_temp + min_temp) / 2 - base_temp) * 365
    ...
    for region_name, district_list in REGIONS.items():
        ...
        for district_name in district_list:
            ...
            if is_gdd:
                ...
                baseline_gdd = max(0, (max_baseline + min_baseline) / 2 - base_temp) * 365
                ...
                future_gdd = max(0, (max_future + min_future) / 2 - base_temp) * 365
